...
def is_spec_decode_supported(req_id: str, input_batch: InputBatch) -> bool:
    if req_id in input_batch.min_p_reqs:
        print ("Spec decode skip on cond 1")
    ...
    #     print ("Spec decode skip on cond 2, req_id: ", req_id)
    #     print ("Freq penalties ", input_batch.frequency_penalties_reqs)
    #     print ("Presence penalties ", input_batch.presence_penalties_reqs)
    #     print ("Repetition penalties ", input_batch.repetition_penalties_reqs)
